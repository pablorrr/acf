...
//////////////////ADD CUSTOM PRODUCT PROGRAMTICCALYY//////////////////////////////////////////
$allowTestFlag = true; // just to block for testing purposes - dont stuck DB after page refresh
if ( empty( $product ) && $allowTestFlag ) {
    //////////////////////////////
    // PRODUCT not exists, insert
    //////////////////////////////
    //tutaj inicjalizacja zmiennej $labelcoProdid = 0 ;
    // nastepnie na koniec petli
    // zwikeszane o 1 za pomaca iteracji i++
    //kod do wykorzytsania przy dodaniu autora
...
////////////****************wooo test***************
 ...
 if(is_admin()){ $user_info = get_userdata(get_current_user_id());}
    $nicename = $user_info->user_nicename;
	$labelcoProdid = 'product name test';
    // njprwdf meta dane
    $post_data  = array(
        'post_status'  => 'publish',
        'post_type'    => 'product',
        'post_content' => 'content test',
        'post_title'   => $labelcoProdid,
        'post_author'  => $nicename,
		'product_cat'  => 'testcat'//nie dzila
    );
...
///////////////////add new product post//////////////////////////////////////////
	...
	//source origin:  https://woocommerce.wp-a2z.org/oik_api/wc_productset_attributes/
	/* spource origin https://hotexamples.com/examples/-/WC_Product_Attribute/set_variation/php-wc_product_attribute-set_variation-method-examples.html*/
	
	$product->set_attributes(array($attribute));
	$product->set_regular_price('45');// param as string
	//TODO : ustawic jako parametry 
	$product->set_height(2.36);//accept param as float or string
	$product->set_height(2.38);//accept param as float or string
	$product->save();
}	